...
### _Bug fixes to following issues_
...
* _Updates made to improve Live Share reliability on activation and authentication_
* _Updates made to improve Live Share de-syncs and language services issues_
* _Updates made to improve security and accessibility_

### _New features_

* _Live Share supports [joining from the browser](https://aka.ms/vsls-web) now for all Live Share sessions [Public Preview]_
* _Live Share for code reviews is now enhanced by allowing follow and focus on diff views [Insiders]_

### _Upcoming features_

* _Planned Sessions: Live Share support for sessions that can be scheduled in advance, coming to Insiders_
* _Live Share built-in chat support for insiders_
