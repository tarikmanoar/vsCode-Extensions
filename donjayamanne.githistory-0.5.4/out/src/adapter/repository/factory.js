    ...
    createGitService(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.gitServices.has(this.repoIndex.toString())) {
                this.gitServices.set(this.repoIndex.toString(), new git_1.Git(this.gitApi.repositories[this.repoIndex], this.serviceContainer, this.gitCmdExecutor, this.logParser, this.gitArgsService));
            }
