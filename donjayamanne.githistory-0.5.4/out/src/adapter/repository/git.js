...
let Git = class Git {
    ...
    getLogEntries(pageIndex = 0, pageSize = 0, branch = '', searchText = '', file, lineNumber, author) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const output = yield this.exec(...args.logArgs);
    ...
    getCommit(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filesWithNumStat = commitOutput.slice(commitOutput.lastIndexOf(constants_1.ITEM_ENTRY_SEPARATOR) + constants_1.ITEM_ENTRY_SEPARATOR.length);
    ...
    createBranch(branchName, hash) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.repo.createBranch(branchName, false, hash);
            }
            catch (ex) {
                throw ex.stderr;
            }
    ...
    createTag(tagName, hash) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.exec('tag', '-a', tagName, '-m', tagName, hash);
        });
    }
    removeTag(tagName) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    removeBranch(branchName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.repo.deleteBranch(branchName);
            }
            catch (ex) {
                throw ex.stderr;
            }
    ...
    removeRemoteBranch(remoteBranchName) {
        return __awaiter(this, void 0, void 0, function* () {
            const pathes = remoteBranchName.split('/');
            const remote = pathes.shift();
            const branchName = pathes.join('/');
            yield this.repo.push(remote, ':' + branchName);
        });
    }
    merge(hash) {
        return __awaiter(this, void 0, void 0, function* () {
