...
const types_6 = require("../application/types");
    ...
    constructor(app, gitServiceFactory, serviceContainer, commandManager) {
        ...
        this.getLogEntries = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            promise = (yield this.getRepository(decodeURIComponent(request.query.id)))
                ...
                // @ts-ignore
                const entriesResponse = Object.assign({}, data, { pageIndex,
                    pageSize });
        ...
        this.getCommit = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.commitViewer.viewCommitTree(new types_3.CommitDetails(gitRoot, branch, commitPromise));
        ...
        this.doActionRef = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                switch (actionName) {
                    case 'removeTag':
                        yield gitService.removeTag(refEntry.name);
                        break;
                    case 'removeBranch':
                        yield gitService.removeBranch(refEntry.name);
                        break;
                    case 'removeRemote':
                        yield gitService.removeRemoteBranch(refEntry.name);
                        break;
                }
        ...
        this.doAction = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                switch (actionName) {
                    default:
                        yield this.commandManager.executeCommand('git.commit.doSomething', new types_3.CommitDetails(gitRoot, branch, logEntry));
                        break;
                    case 'newtag':
                        yield gitService.createTag(value, logEntry.hash.full);
                        logEntry.refs.push({ type: types_5.RefType.Tag, name: value });
                        break;
                    case 'newbranch':
                        yield gitService.createBranch(value, logEntry.hash.full);
                        logEntry.refs.push({ type: types_5.RefType.Head, name: value });
                        break;
                    case 'reset_hard':
        ...
        this.doSomethingWithCommit = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            const branch = yield gitService.getCurrentBranch();
            const logEntry = request.body;
            this.commandManager.executeCommand('git.commit.doSomething', new types_3.CommitDetails(gitRoot, branch, logEntry));
        });
        this.selectCommittedFile = (request, response) => __awaiter(this, void 0, void 0, function* () {
            ...
            this.commandManager.executeCommand('git.commit.file.select', new types_3.FileCommitDetails(gitRoot, branch, body.logEntry, body.committedFile));
        });
        // tslint:disable-next-line:no-any
        ...
        this.applicationShell = this.serviceContainer.get(types_6.IApplicationShell);
