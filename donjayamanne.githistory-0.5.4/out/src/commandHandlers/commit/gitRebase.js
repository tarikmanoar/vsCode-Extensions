...
let GitRebaseCommandHandler = class GitRebaseCommandHandler {
    ...
    rebase(commit, showPrompt = true) {
        return __awaiter(this, void 0, void 0, function* () {
            commit = commit ? commit : this.commitViewerFactory.getCommitViewer().selectedCommit;
            const gitService = yield this.serviceContainer.get(types_4.IGitServiceFactory).createGitService(commit.workspaceFolder);
...
__decorate([
    registration_1.command('git.commit.rebase', types_6.IGitRebaseCommandHandler),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [types_2.CommitDetails, Boolean]),
    __metadata("design:returntype", Promise)
], GitRebaseCommandHandler.prototype, "rebase", null);
GitRebaseCommandHandler = __decorate([
...
], GitRebaseCommandHandler);
exports.GitRebaseCommandHandler = GitRebaseCommandHandler;
//# sourceMappingURL=gitRebase.js.map