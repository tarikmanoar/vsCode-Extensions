...
let GitRevertCommandHandler = class GitRevertCommandHandler {
    ...
    revertCommit(commit, showPrompt = true) {
...
__decorate([
    registration_1.command('git.commit.revert', types_6.IGitRevertCommandHandler),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [types_2.CommitDetails, Boolean]),
    __metadata("design:returntype", Promise)
], GitRevertCommandHandler.prototype, "revertCommit", null);
GitRevertCommandHandler = __decorate([
...
], GitRevertCommandHandler);
exports.GitRevertCommandHandler = GitRevertCommandHandler;
