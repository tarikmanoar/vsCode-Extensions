...
let CommitCommandFactory = class CommitCommandFactory {
    constructor(cherryPickHandler, checkoutHandler, compareHandler, mergeHandler, rebaseHandler, revertHandler, viewChangeLogHandler) {
...
CommitCommandFactory = __decorate([
    ...
    __param(0, inversify_1.inject(types_1.IGitCherryPickCommandHandler)),
    __param(1, inversify_1.inject(types_1.IGitCheckoutCommandHandler)),
    __param(2, inversify_1.inject(types_1.IGitCompareCommandHandler)),
    __param(3, inversify_1.inject(types_1.IGitMergeCommandHandler)),
    __param(4, inversify_1.inject(types_1.IGitRebaseCommandHandler)),
    __param(5, inversify_1.inject(types_1.IGitRevertCommandHandler)),
    __param(6, inversify_1.inject(types_1.IGitCommitViewDetailsCommandHandler)),
