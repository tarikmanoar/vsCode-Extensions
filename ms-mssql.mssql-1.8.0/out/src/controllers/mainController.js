    ...
    activate() {
        ...
        return this.initialize(activationTimer).then((didInitialize) => {
            if (didInitialize) {
                ...
                this._context.subscriptions.push(vscode.window.registerTreeDataProvider('objectExplorer', this._objectExplorerProvider));
                ...
                this._context.subscriptions.push(vscode.commands.registerCommand(Constants.cmdScriptSelect, (node) => __awaiter(this, void 0, void 0, function* () {
                    this.scriptNode(node, scriptingRequest_1.ScriptOperation.Select, true);
                })));
                // Script as Create
                this._context.subscriptions.push(vscode.commands.registerCommand(Constants.cmdScriptCreate, (node) => __awaiter(this, void 0, void 0, function* () { return this.scriptNode(node, scriptingRequest_1.ScriptOperation.Create); })));
                // Script as Drop
                this._context.subscriptions.push(vscode.commands.registerCommand(Constants.cmdScriptDelete, (node) => __awaiter(this, void 0, void 0, function* () { return this.scriptNode(node, scriptingRequest_1.ScriptOperation.Delete); })));
                // Script as Execute
                this._context.subscriptions.push(vscode.commands.registerCommand(Constants.cmdScriptExecute, (node) => __awaiter(this, void 0, void 0, function* () { return this.scriptNode(node, scriptingRequest_1.ScriptOperation.Execute); })));
                // Script as Alter
                this._context.subscriptions.push(vscode.commands.registerCommand(Constants.cmdScriptAlter, (node) => __awaiter(this, void 0, void 0, function* () { return this.scriptNode(node, scriptingRequest_1.ScriptOperation.Alter); })));
