...
* Enable setting of breakpoints in CUDA sources. [PR [#4585](https://github.com/Microsoft/vscode-cpptools/issues/4585)](https://github.com/microsoft/vscode-cpptools/pull/4585)
...
* Fix an issue with configuration error squiggles not being applied unless the setting was set in both `c_cpp_properties.json` and `settings.json`. [PR [#4538](https://github.com/Microsoft/vscode-cpptools/issues/4538)](https://github.com/microsoft/vscode-cpptools/pull/4538)
