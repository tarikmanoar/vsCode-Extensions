...
- Add `b:error` snippets ([@CaddyDz](https://github.com/CaddyDz) - [PR [#95](https://github.com/onecentlin/laravel-blade-snippets-vscode/issues/95)](https://github.com/onecentlin/laravel-blade-snippets-vscode/pull/95))
