...
- Remote support (PR [#401](https://github.com/DonJayamanne/gitHistoryVSCode/issues/401))
- Browser improvements (PR [#406](https://github.com/DonJayamanne/gitHistoryVSCode/issues/406), PR [#407](https://github.com/DonJayamanne/gitHistoryVSCode/issues/407))
- Style amendments by passing `--vscode-*` into the iframe (PR [#360](https://github.com/DonJayamanne/gitHistoryVSCode/issues/360))
- Slightly improved finding submodules using git extension api (PR [#358](https://github.com/DonJayamanne/gitHistoryVSCode/issues/358))
- Fixed typo (PR [#399](https://github.com/DonJayamanne/gitHistoryVSCode/issues/399))
...
- Fixed avatar issues (#349, [#287](https://github.com/DonJayamanne/gitHistoryVSCode/issues/287)) using remote contributors and added avatar cache extension setting (default 1 hour)
---
...
- Fix [#43](https://github.com/DonJayamanne/gitHistoryVSCode/issues/43) [#63](https://github.com/DonJayamanne/gitHistoryVSCode/issues/63) - error when file in not present in a commit
