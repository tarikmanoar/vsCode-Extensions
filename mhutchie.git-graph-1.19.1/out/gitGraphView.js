        ...
        this.panel.webview.onDidReceiveMessage((msg) => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (msg.command) {
                ...
                case 'getSettings':
                    ...
                    break;
                case 'loadCommits':
                    this.sendMessage(Object.assign(Object.assign({ command: 'loadCommits' }, yield this.dataSource.getCommits(msg.repo, msg.branches, msg.maxCommits, msg.showRemoteBranches, msg.showTags, msg.remotes, msg.hideRemotes)), { hard: msg.hard }));
                    break;
                case 'loadRepoInfo':
