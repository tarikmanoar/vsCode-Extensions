    ...
    activate() {
        ...
        return this.initialize(activationTimer).then((didInitialize) => {
            if (didInitialize) {
                ...
                this._scriptingService = new scriptingService_1.ScriptingService(this._connectionMgr, this._vscodeWrapper);
                this._context.subscriptions.push(vscode.commands.registerCommand(Constants.cmdScriptSelect, (node) => __awaiter(this, void 0, void 0, function* () {
                    let actionPromise = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const selectStatement = yield this._scriptingService.scriptSelect(node, nodeUri);
                        ...
                        yield this._outputContentProvider.runQuery(self._statusview, uri, undefined, title, queryPromise);
                        yield queryPromise;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (sessionId) {
                ...
                if (newNode) {
                    ...
                    let expandSessionPromise = new protocol_1.Deferred();
                    yield this._objectExplorerProvider.expandNode(newNode, newNode.sessionId, expandSessionPromise);
                    yield expandSessionPromise;
                    this._objectExplorerProvider.refresh(undefined);
                }
            }
        });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.canRunCommand()) {
                ...
                if (node) {
                    ...
                    yield this.connectionManager.connect(uri.toString(), connectionCreds);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (e.affectsConfiguration(Constants.extensionName)) {
                ...
                for (let conn of newConnections) {
                    ...
                    const uri = objectExplorerUtils_1.ObjectExplorerUtils.getNodeUriFromProfile(conn);
                    if (!this.connectionManager.isActiveConnection(conn) &&
