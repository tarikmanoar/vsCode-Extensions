        ...
        const handler = (result) => __awaiter(this, void 0, void 0, function* () {
            if (result.success) {
                ...
                if (self._currentNode && (self._currentNode.sessionId === result.sessionId)) {
                    ...
                    self._currentNode = treeNodeInfo_1.TreeNodeInfo.fromNodeInfo(result.rootNode, result.sessionId, undefined, self._currentNode.connectionCredentials, nodeLabel);
                }
                else {
                    nodeLabel = nodeLabel === result.rootNode.nodePath ?
                        self.createNodeLabel(nodeConnection) : nodeLabel;
                    self._currentNode = treeNodeInfo_1.TreeNodeInfo.fromNodeInfo(result.rootNode, result.sessionId, undefined, nodeConnection, nodeLabel);
                }
