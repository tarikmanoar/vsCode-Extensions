...
class DataSource {
    constructor(gitExecutable, onDidChangeGitExecutable, logger) {
        this.disposables = [];
        this.logger = logger;
    ...
    getCommits(repo, branches, maxCommits, showRemoteBranches, showTags, remotes, hideRemotes, stashes) {
        const config = config_1.getConfig();
        return Promise.all([
    ...
    getLog(repo, branches, num, includeTags, includeRemotes, order, remotes, hideRemotes, stashes) {
