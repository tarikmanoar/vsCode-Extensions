        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (msg.command) {
                ...
                case 'loadCommits':
                    ...
                    this.sendMessage(Object.assign({ command: 'loadCommits', refreshId: msg.refreshId }, yield this.dataSource.getCommits(msg.repo, msg.branches, msg.maxCommits, msg.showRemoteBranches, msg.showTags, msg.remotes, msg.hideRemotes, msg.stashes)));
                    break;
                case 'loadRepoInfo':
