...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const dataSource = new dataSource_1.DataSource(gitExecutable, onDidChangeGitExecutable, logger);
        const avatarManager = new avatarManager_1.AvatarManager(dataSource, extensionState, logger);
        const repoManager = new repoManager_1.RepoManager(dataSource, extensionState, logger);
        const statusBarItem = new statusBarItem_1.StatusBarItem(repoManager, logger);
        ...
        context.subscriptions.push(vscode.workspace.registerTextDocumentContentProvider(diffDocProvider_1.DiffDocProvider.scheme, new diffDocProvider_1.DiffDocProvider(dataSource)), vscode.workspace.onDidChangeConfiguration(e => {
        ...
        }), commandManager, statusBarItem, repoManager, avatarManager, dataSource, extensionState, gitExecutableEmitter, logger);
